export default {
    ...
    // Home View
    home_templates_found: 'Найденные Шаблоны',
  ...
  home_no_checklists: 'Нет списков.',
    ...
    templates_new: 'Новый',
    templates_items: 'элементов',
    templates_categories: 'категорий',
    templates_use: 'Использовать',
    templates_no_desc: 'Нет описания',

    // Template Editor
    editor_new: 'Новый Шаблон',
  ...
  editor_item_placeholder: 'Текст элемента *',
    ...
    checklist_done_msg: 'Отличная работа! Вы завершили все элементы.',
    ...
    settings_desc: 'Управляйте своими данными и настройками.',
