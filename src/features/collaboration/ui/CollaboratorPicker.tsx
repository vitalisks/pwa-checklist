...
import { Users, Check, Globe, Lock } from 'lucide-react';
...
export const CollaboratorPicker: React.FC<Props> = ({ checklist, onClose }) => {
  ...
  const sheetTitle = alreadyCollaborative ? t.collaboration.addCollaborator : t.collaboration.collaborate;
  ...
  return (
    <BottomSheet isOpen onClose={onClose} title={sheetTitle} icon={<Users size={16} />} footer={sheetFooter}>
      {contacts.length === 0 ? (
